        ...
        success: function (data) {
            data.forEach(function (index) {
                ...
                var startWorkYearInput = $("</input>")
                    .addClass("year")
                    .html(index.startWorkYear);
                var startWorkMonthInput = $("</input>")
                    .addClass("year")
                    .html(index.startWorkMonth);
                var endWorkYearInput = $("</input>")
                    .addClass("year")
                    .html(index.endWorkYear);
                var endWorkMonthInput = $("</input>")
                    .addClass("year")
                    .html(index.endWorkMonth);
                ...
                var startOutcomeyearInput = $("</input>")
                    .addClass("year")
                    .html(index.startOutcomeyear);
                var startOutcomeMonthInput = $("</input>")
                    .addClass("month")
                    .html(index.startOutcomeMonth);
                var endOutcomeYearInput = $("</input>")
                    .addClass("year")
                    .html(index.endOutcomeYear);
                var endOutcomeMonthInput = $("</input>")
                    .addClass("month")
                    .html(index.endOutcomeMonth);
