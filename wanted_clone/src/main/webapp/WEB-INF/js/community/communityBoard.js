$(function () {
    ...
    $(".community_comment__write__content").click(function () {
        if (id == "") {
            ...
            $("#community_comment__write__content_body__btn").css(
                "color",
                "blue"
            );
        }
        ...
        if ($(".community_comment__write__content").val() == "") {
            ...
            $.ajax({
                ...
                data:
                    ...
                    id +
                    "&comment_=" +
                    $(".community_comment__write__content").val() +
                    "&title=" +
                    $(".community_board__title").text(),
                success: function () {
                    location.reload();
                },
                error: function (err) {
    ...
    $(".fa-thumbs-up").click(function () {
        if (like_btn == false) {
            like_btn = true;
            var count =
                Number($(".community_board__bottom__like > span").text()) + 1;
