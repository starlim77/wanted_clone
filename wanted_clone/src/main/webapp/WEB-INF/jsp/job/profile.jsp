                    ...
                    <aside class="profile__title__container__aside">
                        <div class="profile__title__container__aside__sub">
                            <div class="sub__profile">
                                <img
                                    class="sub__profile__img"
                                    src="/controller/img/profile_far_head.png"
                                    alt="profile_default"
                                />
                            </div>
                            <a>
                    ...
                    <section class="profile__title__container__body">
                        <div class="profile__title__container__body__summary">
                            ...
                            <ul class="summary__content">
                                ...
                                <li>
                                    <a>
                                        <em class>0</em> <span>최종 합격</span>
                                    </a>
                                </li>
                                <li>
                                    <a>
                                        <em class>0</em> <span>불합격</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div class="table__list">
                                <ul class="table__list__header__content">
                                    <div class="table__list__header">
                                        <span
                                            class="table__list__header__company"
                                            >지원회사</span
                                        >
                                        <span
                                            class="table__list__header__position"
                                            >지원 포지션</span
                                        >
                                        <span
                                            class="table__list__header__period"
                                            >작성시간</span
                                        >
                                        <span
                                            class="table__list__header__progress"
                                            >진행상태</span
                                        >
                                    </div>
                                    <c:forEach
                                    ...
                                    >
                                        <li>
                                            <div>
                                                <span
                                                    class="table__list__header__company"
                                                    >${jobApplyDTO.company}</span
                                                >
                                            </div>
                                            <div>
                                                <span
                                                    class="table__list__header__position"
                                                    >${jobApplyDTO.position}</span
                                                >
                                            </div>
                                            <div>
                                                <span
                                                    class="table__list__header__period"
                                                    >${jobApplyDTO.logtime}</span
                                                >
                                            </div>
                                            <div>
                                                <span
                                                    class="table__list__header__progress"
                                                    >${jobApplyDTO.apply}</span
                                                >
                                            </div>
                                        </li>
                                    </c:forEach>
