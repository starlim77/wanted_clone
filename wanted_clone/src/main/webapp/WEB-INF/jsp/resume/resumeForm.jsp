<%@ page language="java" contentType="text/html; charset=UTF-8"
        ...
        <div class="resume-form-cotainer">
            ...
            <form name="resumeForm" class="resume-form">
                <div class="resume-form__wrapper">
                    <input type="text" class="resume_seq" name="resume_seq" value=${param.resumeSeq} >
                   ...
                   <div class="intorduce__txt">
                    ...
                    <div class="resume-form__introduce">
                        ...
                        <div class="introduce-div">
                               <textarea class="introduce" name="introduce" rows="13"></textarea><br>
                          </div>
                    </div>
                            ...
                            <div class="add-career">
                                ...
                                <div class="detail-form">
                                    ...
                                    <div class="detail-date">
                                        ...
                                        .
                                        <input type="text" name="startMonth" class="month detail-input" maxlength="2" placeholder="MM" onKeyup="this.value=this.value.replace(/[^-0-9]/g,'');">
                                        -
                                        <input type="text" name="endYear" class="year detail-input" maxlength="4" placeholder="YYYY" onKeyup="this.value=this.value.replace(/[^-0-9]/g,'');">
                                        .
                                        <input type="text" name="endMonth" class="month detail-input" maxlength="2" placeholder="MM" onKeyup="this.value=this.value.replace(/[^-0-9]/g,'');">
                                    </div>
                                    <div class="detail-content">
                                        <input type="text" name="outcomeContent" class="detail-content__input detail-input" placeholder="상세 업무 내용과 성과를 기입해주세요">
                                    </div>
                                </div>
                                <!-- 주요성과 추가 완료 버튼 -->
                                <div class="add-career__submit">
                                    <button type="button" class="submit-btn" value="0">추가하기</button>
                                </div>
                            </div>
                        </div>
                    </div>
                   ...
                   <div class="education-wrapper">
                        ...
                        <div class="add-form">
                            <div class="add-career">
                                ...
                                <div class="add-career__submit">
                                    <button type="button" class="submit-btn" value="1">추가하기</button>
                                </div>
                            </div>
                        </div>
                    </div>  
    ...
    <footer class="resume-form-footer">
        <button type="button" id="tempSave" class="writing" name="writing" value="0">임시 저장</button>
        <button type="button" id="save" class="writing" name="writing" value="1">작성 완료</button>
    </footer>

    <script src="https://code.jquery.com/jquery-latest.min.js"></script>
    <script src="https://kit.fontawesome.com/1f61694686.js"
        crossorigin="anonymous"></script>
    <script type="text/javascript" src="../js/resume/resumeForm.js"></script>
</body>
</html>